...
type Contract struct {
	...
	// LatestDelivery is the most recent delivery of the contract, populated by
	// the service on contract detail queries.
	LatestDelivery *ContractDelivery `gorm:"-" json:"latestDelivery,omitempty"`
}
